  ...
  return (
    <div className="container">
      ...
      <section className="subscriptions">
        <button
          disabled={currentUser?.subscription_id?._id === "68380950c659b1a48ce18927"}
          onClick={() => {
        ...
        <button
          disabled={currentUser?.subscription_id?._id === "68380992c659b1a48ce18928"}
          onClick={() => {
        ...
        <button
          disabled={currentUser?.subscription_id?._id === "683809b3c659b1a48ce18929"}
          onClick={() => {
      ...
      {popupTrigger && currentUser && newSubscription && (
